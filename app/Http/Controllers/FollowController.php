...
class FollowController extends Controller
{
    ...
    public function store($follow_id)
    {
        // Save in the database
        $follow = new Follow;
        $follow -> userFollower_id = Auth::id();
        $follow -> userFollowed_id = $follow_id;
        ...
        return redirect() -> route('users.show', $follow_id);
    }
    ...
    public function destroy($follow_id)
    {
        ...
        if ((Auth::user() -> id == $follow -> follow_id) or (Auth::user() -> is_admin == 1) )
        {
